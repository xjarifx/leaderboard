...
// @ts-nocheck 
/*
 * This file exports the `SessionQueue` model and its related types.
 *
...
export type GetSessionQueueAggregateType<T extends SessionQueueAggregateArgs> = {
      [P in keyof T & keyof AggregateSessionQueue]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSessionQueue[P]>
    : Prisma.GetScalarType<T[P], AggregateSessionQueue[P]>
}
...
export type GetSessionQueueGroupByPayload<T extends SessionQueueGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SessionQueueGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SessionQueueGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SessionQueueGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SessionQueueGroupByOutputType[P]>
      }
    >
  >
...
export type SessionQueueCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<SessionQueueFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SessionQueueDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['SessionQueue'], meta: { name: 'SessionQueue' } }
  /**
   ...
   * })
  **/
  count<T extends SessionQueueCountArgs>(
    args?: Prisma.Subset<T, SessionQueueCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SessionQueueCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends SessionQueueGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, SessionQueueGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSessionQueueGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
